<%@ Page Title="" Language="C#" MasterPageFile="~/MAINMST.Master" AutoEventWireup="true" CodeBehind="frmHCISNewContactVEN.aspx.cs" Inherits="APPBASE.frmHCISNewContactVEN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeadCustomHolder" runat="server">
    ...
    <!--Custom JS -->
    <script src="frmHCISNewContactVEN.js" type="text/javascript"></script>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageContentHolder" runat="server">
    <form id="frmHCISNewContactVEN" runat="server">

        <div class="FormEntry">
            <table>
                <tr>
                    <td colspan="3">
                    <h1>Entry Data Supplier</h1>
                    <hr />
                    </td>
                </tr>
